...
export default function ProductHeader({ isActive, handleBack, isDark }) {
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-2xl p-4 md:p-5 mb-6 shadow-sm transition-all duration-500 ease-out ${
    ...
    >
      ...
      <button
        onClick={handleBack}
        className={`inline-flex items-center gap-2 px-3 py-1.5 text-xs sm:text-sm rounded-full transition-all duration-300 mb-4 cursor-pointer group border ${
          isDark
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="space-y-1.5 max-w-2xl">
          ...
          <h1
            className={`text-lg md:text-xl font-extrabold tracking-tight leading-snug transition-colors ${
          ...
          <p
            className={`text-xs md:text-sm leading-relaxed font-medium transition-colors ${
        ...
        {/* Status card */}
        <div
          className={`w-full lg:w-60 border rounded-xl p-3 self-start lg:self-center shadow-sm transition-colors ${
